<div class="responsive-header">
    <div class="mh-head first Sticky">
        ...
        <span class="mh-text">
            <a href="{{ url('/') }}" title=""><img src="{{ asset('assets/images/logo2.png') }}"
                    alt=""></a>
        </span>
    ...
    <nav id="menu" class="res-menu">
        <ul>
            <li><span>Home</span>
                <ul>
                    <li><a href="{{ url('/') }}" title="">Home Social</a></li>
                    <li><a href="{{ url('/') }}" title="">Home Social 2</a></li>
                    <li><a href="{{ url('/') }}" title="">Home Company</a></li>
                    <li><a href="{{ url('/') }}" title="">Login page</a></li>
                    <li><a href="{{ url('/') }}" title="">Logout Page</a></li>
                    <li><a href="{{ url('/') }}" title="">news feed</a></li>
                </ul>
            </li>
...
<div class="topbar stick">
    <div class="logo">
        <a title="" href="{{ url('/') }}"><img src="{{ asset('assets/images/logo.png') }}"
                alt=""></a>
    </div>
    ...
    <div class="top-area">
        <ul class="main-menu d-flex">
            <div class="text-center">
                <a href="{{ url('/') }}" class="active" title="Home"><i class="ti-home"></i></a>
            </div>
            <div>
                <a href="#" title=""><i class="ti-comment"></i> </a>
            </div>
            <div>
                <a href="#" title=""><i class="ti-bell"></i> </a>
            </div>
            <div>
                <a href="#" title=""><i class="ti-settings"></i></a>
            </div>
        </ul>
