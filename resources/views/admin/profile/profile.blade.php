            ...
            <div class="row">
                <div class="col-12">
                    <ul class="nav nav-pills mb-2">
                        <!-- account -->
                        <li class="nav-item">
                            <a class="nav-link profile {{request()->routeIs('admin.profile')?"active":""}}" href="javascript:void(0)" data-id="1">
                    ...
                    <!-- profile -->
                    <div class="card" id="profile" style="{{request()->routeIs('admin.profile')?"display:block":"display:none"}}">
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input id="mobile" type="text" class="form-control" value="{{Auth::guard('admin')->user()->phone_no}}" name="phone_no" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="email" class="form-control" placeholder="Email" value="{{Auth::guard('admin')->user()->email}}" name="email" id="email" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="GET" action="{{route('admin.profile.setting')}}" class="form-validate">
                                ...
                                <div class="row mt-1">
                                    ...
                                    <div class="col-12 col-sm-6 mb-1">
                                        <label class="form-label" for="account-retype-new-password">Confirm Password</label>
                                        <div class="input-group form-password-toggle input-group-merge">
                                            <input type="password" class="form-control" id="account-retype-new-password" name="confirm_password" placeholder="Confirm your new password" />
