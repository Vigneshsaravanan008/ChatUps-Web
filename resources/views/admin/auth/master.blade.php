...
<head>
    ...
    <title>Login Page - Einstro Academy</title>
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="{{route('admin_login')}}">
                            <h2 class="brand-text text-primary ms-1"><img src="{{asset(@$settings->white_favicon_icon)}}" width="100px" height="35px" alt="ChatUps"/></h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
